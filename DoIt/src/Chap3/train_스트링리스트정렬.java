...
public class train_스트링리스트정렬 {
	...
	//중복되는걸 지우고 땡김
	    ...
	    static void sortList(List<String> list) { //중요
	    	//리스트를 배열로 변환
	    	list.toArray()
	    	//배열에서 중복제거
		...
		public static void main(String[] args) {
			ArrayList<String> list = new ArrayList<>();//ArrayList<T>리스트, 정렬, 찾기, merse
			getList(list);
			showList("입력후", list);
			//sort - 오름차순으로 정렬, 내림차순으로 정렬, 중복 제거하는 코딩

//		    Collections.sort(list);//list는 배열이 아님. array가 아닌 collection
