...
public class Test09 {
	...
	public static void main(String[] args) {
		...
		users.put("20120924", "김용빈"); //key, value

		System.out.println(users);

		Map.Entry<String, String> entry = null;//entry:참조변수

		//tree로 정렬된걸 만들수있음 4 5 9 12 13 15 17 순으로(inorder traversal()). binary search tree
		entry = users.firstEntry();//tree의 첫번째 entry
