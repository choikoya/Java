...
public class Test01_arraylist {
	public static void main(String[] args) {
		Object arr[] = new Object[10];//Sting, Integer의 root가 Object > object
		String s = "java";
		Integer i1 = 123;
		arr[0] = s;
		arr[1] = i1;
		//arr[0] //.찍으면 사용가능한 메서드 나오는데 자동생성중에 math가 없음
		...
		list.add(1, "LA");//인덱스 1 위치에 LA 추가. 북경이 밀림
		print(2, list);
		...
		List<String> list2 = Arrays.asList("서울", "뉴욕", "상해");//Arrays클래스의 asList메서드에 리스트를 배열로. asList()는 배열을 입력받아 리스트를 만든다 
		print(12, list2);
